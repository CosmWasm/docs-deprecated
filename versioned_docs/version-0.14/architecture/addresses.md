...
This actual format and interfaces are still under discussion, and we are still working on a [tutorial version of a
 name service](../learn/name-service/intro.md). However, for sake of argument, imagine we agree every *Address* that
