...
- Remove the previously deprecated `StdError::Unauthorized`. Contract specific
  ...
  [migration guide](07_MIGRATING.md) 0.10 -> 0.11).
...
- Pass `Env` into `query` as well. As this doesn't have `MessageInfo`, we
  ...
  [type definitions in the README](https://github.com/CosmWasm/cosmwasm/blob/master/README.md#implementing-the-smart-contract) to
