...
development, digest the [Getting Started](/docs/02_getting-started/intro.md) documentation.
...
1. Download [source code](https://github.com/CosmWasm/cosmwasm-plus/tree/v0.1.1/contracts/cw20-base), and [compile](/docs/02_getting-started/compile-contract.md) it your self.
