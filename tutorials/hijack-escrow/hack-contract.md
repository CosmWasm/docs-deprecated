...
interacts with the user. There is [more info on addresses here](/docs/architecture/addresses).
...
If we now look into the `try_approve` function, we will see how we can respond to a message. We can return
