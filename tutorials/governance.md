...
in smart contract development, digest the [Getting Started](/docs/getting-started/intro) documentation.
...
1. Download [source code](https://github.com/CosmWasm/cosmwasm-plus/tree/v0.1.1/contracts/cw20-base),
   and [compile](/docs/getting-started/compile-contract) it your self.
